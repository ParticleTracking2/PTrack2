...
%cleanCloseObjectCluster verifiy a set of 2D points (x,y) to be at least at
%distance D, grouped in a set of clusters (cx,cy)
%
%   [xcheck,ycheck,Nfinal]=cleanCloseObjectCluster(x,y, cx, cy, D, L, M)
%   the input set of 2D points is defined in arrays (x,y), cluster set
%   is defined in arrays (cx,cy), min distance in D, size of the image is
%   defined in L, M is the size of the margin where no points should be
%   present
