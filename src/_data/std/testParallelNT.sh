...
function doit {
	time ./PTrack2 chi2hd -i ImgA000000.tif -out ./Out/data-$1-$2.txt -silent -nothreads -2filteri 0.5
}
...
(time main $1) 2> ./std/time-total-parallel-no-threads.txt
echo "Test Ended"
rm -R Out/
